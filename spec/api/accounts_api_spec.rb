...
# Unit tests for MergeCRMClient::AccountsApi
...
describe 'AccountsApi' do
  ...
  describe 'test an instance of AccountsApi' do
    it 'should create an instance of AccountsApi' do
      expect(@api_instance).to be_instance_of(MergeCRMClient::AccountsApi)
    end
  end
  ...
  # @param crm_account_endpoint_request 
  ...
  # unit tests for accounts_meta_patch_retrieve
  # Returns metadata for &#x60;CRMAccount&#x60; PATCHs.
  # @param x_account_token Token identifying the end user.
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [MetaResponse]
  describe 'accounts_meta_patch_retrieve test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # @param x_account_token Token identifying the end user.
  # @param id 
  # @param patched_crm_account_endpoint_request 
  # @param [Hash] opts the optional parameters
  # @option opts [Boolean] :is_debug_mode Whether to include debug fields (such as log file links) in the response.
  # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
  # @return [CRMAccountResponse]
  ...
  # unit tests for accounts_remote_field_classes_list
  ...
  describe 'accounts_remote_field_classes_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
