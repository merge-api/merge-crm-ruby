...
# Unit tests for MergeCRMClient::TasksApi
...
describe 'TasksApi' do
  ...
  describe 'test an instance of TasksApi' do
    it 'should create an instance of TasksApi' do
      expect(@api_instance).to be_instance_of(MergeCRMClient::TasksApi)
    end
  end
  ...
  # unit tests for tasks_meta_patch_retrieve
  # Returns metadata for &#x60;Task&#x60; PATCHs.
  # @param x_account_token Token identifying the end user.
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [MetaResponse]
  describe 'tasks_meta_patch_retrieve test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for tasks_meta_post_retrieve
  # Returns metadata for &#x60;Task&#x60; POSTs.
  # @param x_account_token Token identifying the end user.
  # @param [Hash] opts the optional parameters
  # @return [MetaResponse]
  describe 'tasks_meta_post_retrieve test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # @param x_account_token Token identifying the end user.
  # @param id 
  # @param patched_task_endpoint_request 
  # @param [Hash] opts the optional parameters
  # @option opts [Boolean] :is_debug_mode Whether to include debug fields (such as log file links) in the response.
  # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
  # @return [TaskResponse]
  ...
  # unit tests for tasks_remote_field_classes_list
  ...
  describe 'tasks_remote_field_classes_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
