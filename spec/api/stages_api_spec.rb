...
# Unit tests for MergeCRMClient::StagesApi
...
describe 'StagesApi' do
  ...
  describe 'test an instance of StagesApi' do
    it 'should create an instance of StagesApi' do
      expect(@api_instance).to be_instance_of(MergeCRMClient::StagesApi)
    end
  end

  # unit tests for stages_list
  ...
  # unit tests for stages_retrieve
