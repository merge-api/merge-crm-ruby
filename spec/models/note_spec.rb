...
# Unit tests for MergeCRMClient::Note
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeCRMClient::Note do
  let(:instance) { MergeCRMClient::Note.new }

  describe 'test an instance of Note' do
    it 'should create an instance of Note' do
      expect(instance).to be_instance_of(MergeCRMClient::Note)
    end
  end
