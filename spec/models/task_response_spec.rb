...
# Unit tests for MergeCRMClient::TaskResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeCRMClient::TaskResponse do
  let(:instance) { MergeCRMClient::TaskResponse.new }

  describe 'test an instance of TaskResponse' do
    it 'should create an instance of TaskResponse' do
      expect(instance).to be_instance_of(MergeCRMClient::TaskResponse)
    end
  end
