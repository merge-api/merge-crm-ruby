...
# Unit tests for MergeCRMClient::User
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeCRMClient::User do
  let(:instance) { MergeCRMClient::User.new }

  describe 'test an instance of User' do
    it 'should create an instance of User' do
      expect(instance).to be_instance_of(MergeCRMClient::User)
    end
  end
