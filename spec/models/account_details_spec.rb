...
# Unit tests for MergeCRMClient::AccountDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeCRMClient::AccountDetails do
  let(:instance) { MergeCRMClient::AccountDetails.new }

  describe 'test an instance of AccountDetails' do
    it 'should create an instance of AccountDetails' do
      expect(instance).to be_instance_of(MergeCRMClient::AccountDetails)
    end
  end
