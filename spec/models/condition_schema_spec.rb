...
# Unit tests for MergeCRMClient::ConditionSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeCRMClient::ConditionSchema do
  let(:instance) { MergeCRMClient::ConditionSchema.new }

  describe 'test an instance of ConditionSchema' do
    it 'should create an instance of ConditionSchema' do
      expect(instance).to be_instance_of(MergeCRMClient::ConditionSchema)
    end
  end
