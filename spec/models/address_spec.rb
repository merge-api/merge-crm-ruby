...
# Unit tests for MergeCRMClient::Address
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeCRMClient::Address do
  let(:instance) { MergeCRMClient::Address.new }

  describe 'test an instance of Address' do
    it 'should create an instance of Address' do
      expect(instance).to be_instance_of(MergeCRMClient::Address)
    end
  end
