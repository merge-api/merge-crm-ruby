...
# Unit tests for MergeCRMClient::Stage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeCRMClient::Stage do
  let(:instance) { MergeCRMClient::Stage.new }

  describe 'test an instance of Stage' do
    it 'should create an instance of Stage' do
      expect(instance).to be_instance_of(MergeCRMClient::Stage)
    end
  end
