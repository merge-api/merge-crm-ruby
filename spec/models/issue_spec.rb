...
# Unit tests for MergeCRMClient::Issue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeCRMClient::Issue do
  let(:instance) { MergeCRMClient::Issue.new }

  describe 'test an instance of Issue' do
    it 'should create an instance of Issue' do
      expect(instance).to be_instance_of(MergeCRMClient::Issue)
    end
  end
