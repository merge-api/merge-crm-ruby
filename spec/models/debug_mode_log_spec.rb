...
# Unit tests for MergeCRMClient::DebugModeLog
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeCRMClient::DebugModeLog do
  let(:instance) { MergeCRMClient::DebugModeLog.new }

  describe 'test an instance of DebugModeLog' do
    it 'should create an instance of DebugModeLog' do
      expect(instance).to be_instance_of(MergeCRMClient::DebugModeLog)
    end
  end
