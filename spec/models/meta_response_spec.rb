...
# Unit tests for MergeCRMClient::MetaResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeCRMClient::MetaResponse do
  let(:instance) { MergeCRMClient::MetaResponse.new }

  describe 'test an instance of MetaResponse' do
    it 'should create an instance of MetaResponse' do
      expect(instance).to be_instance_of(MergeCRMClient::MetaResponse)
    end
  end
