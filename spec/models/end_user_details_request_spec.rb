...
# Unit tests for MergeCRMClient::EndUserDetailsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeCRMClient::EndUserDetailsRequest do
  let(:instance) { MergeCRMClient::EndUserDetailsRequest.new }

  describe 'test an instance of EndUserDetailsRequest' do
    it 'should create an instance of EndUserDetailsRequest' do
      expect(instance).to be_instance_of(MergeCRMClient::EndUserDetailsRequest)
    end
  end
