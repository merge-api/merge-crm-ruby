...
# Unit tests for MergeCRMClient::AddressRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeCRMClient::AddressRequest do
  let(:instance) { MergeCRMClient::AddressRequest.new }

  describe 'test an instance of AddressRequest' do
    it 'should create an instance of AddressRequest' do
      expect(instance).to be_instance_of(MergeCRMClient::AddressRequest)
    end
  end
