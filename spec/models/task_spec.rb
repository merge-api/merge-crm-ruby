...
# Unit tests for MergeCRMClient::Task
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeCRMClient::Task do
  let(:instance) { MergeCRMClient::Task.new }

  describe 'test an instance of Task' do
    it 'should create an instance of Task' do
      expect(instance).to be_instance_of(MergeCRMClient::Task)
    end
  end
