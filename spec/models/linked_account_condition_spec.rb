...
# Unit tests for MergeCRMClient::LinkedAccountCondition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeCRMClient::LinkedAccountCondition do
  let(:instance) { MergeCRMClient::LinkedAccountCondition.new }

  describe 'test an instance of LinkedAccountCondition' do
    it 'should create an instance of LinkedAccountCondition' do
      expect(instance).to be_instance_of(MergeCRMClient::LinkedAccountCondition)
    end
  end
