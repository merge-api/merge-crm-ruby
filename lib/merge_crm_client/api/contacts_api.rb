...
module MergeCRMClient
  class ContactsApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def contacts_ignore_create(x_account_token, model_id, ignore_common_model_request, opts = {})
      contacts_ignore_create_with_http_info(x_account_token, model_id, ignore_common_model_request, opts)
      nil
    end
    ...
    def contacts_ignore_create_with_http_info(x_account_token, model_id, ignore_common_model_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactsApi.contacts_ignore_create ...'
      end
      # verify the required parameter 'x_account_token' is set
      if @api_client.config.client_side_validation && x_account_token.nil?
        fail ArgumentError, "Missing the required parameter 'x_account_token' when calling ContactsApi.contacts_ignore_create"
      end
      # verify the required parameter 'model_id' is set
      if @api_client.config.client_side_validation && model_id.nil?
        fail ArgumentError, "Missing the required parameter 'model_id' when calling ContactsApi.contacts_ignore_create"
      end
      ...
      if @api_client.config.client_side_validation && ignore_common_model_request.nil?
        fail ArgumentError, "Missing the required parameter 'ignore_common_model_request' when calling ContactsApi.contacts_ignore_create"
      end
      # resource path
      local_var_path = '/contacts/ignore/{model_id}'.sub('{' + 'model_id' + '}', CGI.escape(model_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ContactsApi.contacts_ignore_create",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContactsApi#contacts_ignore_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [MetaResponse]
    def contacts_meta_patch_retrieve(x_account_token, id, opts = {})
      data, _status_code, _headers = contacts_meta_patch_retrieve_with_http_info(x_account_token, id, opts)
      data
    end
    ...
    def contacts_meta_patch_retrieve_with_http_info(x_account_token, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactsApi.contacts_meta_patch_retrieve ...'
      end
      # verify the required parameter 'x_account_token' is set
      if @api_client.config.client_side_validation && x_account_token.nil?
        fail ArgumentError, "Missing the required parameter 'x_account_token' when calling ContactsApi.contacts_meta_patch_retrieve"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactsApi.contacts_meta_patch_retrieve"
      end
      # resource path
      local_var_path = '/contacts/meta/patch/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ContactsApi.contacts_meta_patch_retrieve",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContactsApi#contacts_meta_patch_retrieve\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param x_account_token [String] Token identifying the end user.
    # @param id [String] 
    # @param patched_crm_contact_endpoint_request [PatchedCRMContactEndpointRequest] 
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :is_debug_mode Whether to include debug fields (such as log file links) in the response.
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [CRMContactResponse]
    def contacts_partial_update(x_account_token, id, patched_crm_contact_endpoint_request, opts = {})
      data, _status_code, _headers = contacts_partial_update_with_http_info(x_account_token, id, patched_crm_contact_endpoint_request, opts)
      data
    end
    ...
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [Array<(CRMContactResponse, Integer, Hash)>] CRMContactResponse data, response status code and response headers
    def contacts_partial_update_with_http_info(x_account_token, id, patched_crm_contact_endpoint_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactsApi.contacts_partial_update ...'
      end
      # verify the required parameter 'x_account_token' is set
      if @api_client.config.client_side_validation && x_account_token.nil?
        fail ArgumentError, "Missing the required parameter 'x_account_token' when calling ContactsApi.contacts_partial_update"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactsApi.contacts_partial_update"
      end
      # verify the required parameter 'patched_crm_contact_endpoint_request' is set
      if @api_client.config.client_side_validation && patched_crm_contact_endpoint_request.nil?
        fail ArgumentError, "Missing the required parameter 'patched_crm_contact_endpoint_request' when calling ContactsApi.contacts_partial_update"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(patched_crm_contact_endpoint_request)
      ...
      new_options = opts.merge(
        :operation => :"ContactsApi.contacts_partial_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContactsApi#contacts_partial_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def contacts_remote_field_classes_list(x_account_token, opts = {})
      data, _status_code, _headers = contacts_remote_field_classes_list_with_http_info(x_account_token, opts)
      data
    end
    ...
    def contacts_remote_field_classes_list_with_http_info(x_account_token, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactsApi.contacts_remote_field_classes_list ...'
      end
      # verify the required parameter 'x_account_token' is set
      if @api_client.config.client_side_validation && x_account_token.nil?
        fail ArgumentError, "Missing the required parameter 'x_account_token' when calling ContactsApi.contacts_remote_field_classes_list"
      end
      # resource path
      local_var_path = '/contacts/remote-field-classes'
      ...
      new_options = opts.merge(
        :operation => :"ContactsApi.contacts_remote_field_classes_list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContactsApi#contacts_remote_field_classes_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
