...
module MergeCRMClient
  class AccountsApi
    ...
    # @param crm_account_endpoint_request [CRMAccountEndpointRequest] 
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :is_debug_mode Whether to include debug fields (such as log file links) in the response.
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [CRMAccountResponse]
    def accounts_create(x_account_token, crm_account_endpoint_request, opts = {})
      data, _status_code, _headers = accounts_create_with_http_info(x_account_token, crm_account_endpoint_request, opts)
      data
    end
    ...
    def accounts_create_with_http_info(x_account_token, crm_account_endpoint_request, opts = {})
      ...
      # verify the required parameter 'crm_account_endpoint_request' is set
      if @api_client.config.client_side_validation && crm_account_endpoint_request.nil?
        fail ArgumentError, "Missing the required parameter 'crm_account_endpoint_request' when calling AccountsApi.accounts_create"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(crm_account_endpoint_request)
