...
module MergeCRMClient
  class EngagementTypesApi
    ...
    def engagement_types_remote_field_classes_list(x_account_token, opts = {})
      data, _status_code, _headers = engagement_types_remote_field_classes_list_with_http_info(x_account_token, opts)
      data
    end
    ...
    def engagement_types_remote_field_classes_list_with_http_info(x_account_token, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EngagementTypesApi.engagement_types_remote_field_classes_list ...'
      end
      # verify the required parameter 'x_account_token' is set
      if @api_client.config.client_side_validation && x_account_token.nil?
        fail ArgumentError, "Missing the required parameter 'x_account_token' when calling EngagementTypesApi.engagement_types_remote_field_classes_list"
      end
      # resource path
      local_var_path = '/engagement-types/remote-field-classes'
      ...
      new_options = opts.merge(
        :operation => :"EngagementTypesApi.engagement_types_remote_field_classes_list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EngagementTypesApi#engagement_types_remote_field_classes_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
