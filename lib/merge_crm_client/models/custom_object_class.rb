  ...
  class CustomObjectClass
    ...
    def self.openapi_types
      {
        ...
        :'fields' => :'Array<RemoteFieldClassForCustomObjectClass>',
        :'association_types' => :'Array<Hash<String, Object>>',
        :'id' => :'String',
        :'remote_id' => :'String',
        :'modified_at' => :'Time'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MergeCRMClient::CustomObjectClass` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MergeCRMClient::CustomObjectClass`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [name, description, labels, fields, association_types, id, remote_id, modified_at].hash
    end
