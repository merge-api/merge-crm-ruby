...
module MergeCRMClient
  ...
  class Account
    ...
    def hash
      [owner, name, description, industry, website, number_of_employees, addresses, phone_numbers, last_activity_at, remote_updated_at, remote_created_at, remote_was_deleted, id, remote_id, modified_at, field_mappings, remote_data, remote_fields].hash
    end
