...
module MergeCRMClient
  ...
  class Lead
    ...
    def hash
      [id, remote_id, owner, lead_source, title, company, first_name, last_name, addresses, email_addresses, phone_numbers, remote_updated_at, remote_created_at, converted_date, converted_contact, converted_account, remote_data, remote_was_deleted].hash
    end
