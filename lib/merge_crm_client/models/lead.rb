...
module MergeCRMClient
  ...
  class Lead
    ...
    def hash
      [owner, lead_source, title, company, first_name, last_name, addresses, email_addresses, phone_numbers, remote_updated_at, remote_created_at, converted_date, converted_contact, converted_account, remote_was_deleted, id, remote_id, modified_at, field_mappings, remote_data, remote_fields].hash
    end
