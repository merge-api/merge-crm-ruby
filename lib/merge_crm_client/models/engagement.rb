...
module MergeCRMClient
  ...
  class Engagement
    ...
    def hash
      [owner, content, subject, direction, engagement_type, start_time, end_time, account, contacts, remote_was_deleted, id, remote_id, modified_at, field_mappings, remote_data, remote_fields].hash
    end
