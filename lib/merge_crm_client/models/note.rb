...
module MergeCRMClient
  ...
  class Note
    ...
    def hash
      [owner, content, contact, account, opportunity, remote_updated_at, remote_created_at, remote_was_deleted, id, remote_id, field_mappings, modified_at, remote_data, remote_fields].hash
    end
