...
module MergeCRMClient
  ...
  class Opportunity
    ...
    def hash
      [name, description, amount, owner, account, stage, status, last_activity_at, close_date, remote_created_at, remote_was_deleted, id, remote_id, modified_at, field_mappings, remote_data, remote_fields].hash
    end
