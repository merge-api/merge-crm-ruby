# MergeCRMClient::EngagementTypesApi
...
#### Using the engagement_types_list_with_http_info variant
...
> <PaginatedRemoteFieldClassList> engagement_types_remote_field_classes_list(x_account_token, opts)
...
begin
  ...
  result = api_instance.engagement_types_remote_field_classes_list(x_account_token, opts)
  p result
rescue MergeCRMClient::ApiError => e
  puts "Error when calling EngagementTypesApi->engagement_types_remote_field_classes_list: #{e}"
end
```

#### Using the engagement_types_remote_field_classes_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<PaginatedRemoteFieldClassList>, Integer, Hash)> engagement_types_remote_field_classes_list_with_http_info(x_account_token, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.engagement_types_remote_field_classes_list_with_http_info(x_account_token, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <PaginatedRemoteFieldClassList>
rescue MergeCRMClient::ApiError => e
  puts "Error when calling EngagementTypesApi->engagement_types_remote_field_classes_list_with_http_info: #{e}"
end
```
